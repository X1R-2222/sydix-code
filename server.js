...
const IDler = {
  botID: "758816376533286962",
  botToken: "NzU4ODE2Mzc2NTMzMjg2OTYy.X20c0g.ulzOQ4N1xmATHAYR6RIOxWDNyUM",
  botSecret: "6I_xSkCSLoVyxsCAIWEVZ8AOOCY1qTWQ",
  botCallbackURL: "https://sydix-codes.glitch.me/callback",
  sunucuID: "758685378785574942",
  sunucuDavet: "https://discord.gg/dF56Pv8",
  kodLogKanalı: "759001366307012638",
  sahipRolü: "759001595916320809",
  adminRolü: "759001595916320809",
  kodPaylaşımcıRolü: "759001595916320809",
  boosterRolü: "759001595916320809",
  kodPaylaşamayacakRoller: ["BANLI ROL İD", "BANLI ROL İD"],
  hazırAltyapılarRolü: "759078442838392863",
  hazırSistemlerRolü: "759078442838392863",
  elmasKodlarRolü: "759078442838392863",
  altınKodlarRolü: "759078442838392863",
  normalKodlarRolü: "759078442838392863"
};
...
app.post("/paylasim", (req, res) => {
  ...
  client.channels.cache.get(IDler.kodLogKanalı).send(
    ...
    .addField("Kod Sayfası", `[Tıkla!](https://sydix-codes.glitch.me//${obj.kod_rank}/${obj.id})`));
